...
$(document).ready(function () {
  ...
  $('#modalVerificarCPF').find('button[form=CPFForm]').click(function () {
        ...
        var redirect = window.base_url + '/faces/usuario/' + papel + '/inscricao_' + papel + '.xhtml?cpf=' + cpf;
        
        //Chama por ajax
        //$.get(base_url+'home/home_ctr/verificar_cpf/'+cpf, function (data) {
        
        $.get(window.base_url + '/webresources/home/verificar_cpf/' + cpf, function (data) {
            ...
            if (result) {
                ...
                $('#modalLogin').find('input[name=j_username]').val(cpf);
